...
export const reqAddOrUpdateSkuNum = (skuId, skuNum) =>
  requests({
...
export const deleteShopOfCart = (skuId) =>
  requests({
...
export const searchResultPay = (orderId) =>
  requests({ url: `/payment/weixin/queryPayStatus/${orderId}` });

// 获取我的订单
// /api/order/auth/{page}/{limit}  GET    参数： oage，limit
